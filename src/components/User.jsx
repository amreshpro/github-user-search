...
// console.log(user,repos,follower)


const {login,avatar_url,html_url ,location,blog,bio,name,twitter_username,company} = {...user}
...
<div className="bottom-info mt-4">
    <div className="company flex gap-1 m-1">
        <FaLayerGroup className='text-gray-400 mt-1 '/> <h1 className='text-gray-500'>{company}</h1>
    </div>
