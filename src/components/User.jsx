...
<div className="top flex gap-3 flex-wrap justify-start items-center ">
...
<a className="btn-follow h-fit text-white bg-blue-400 px-2 p-1 rounded-lg m-1 hover:bg-purple-400" href={html_url}>Follow</a>

    </div>
</div>
<div className="bottom">
    <div className="des flex flex-wrap text-gray-600 m-1 mb-1 mt-2">
      {bio}
    </div>
